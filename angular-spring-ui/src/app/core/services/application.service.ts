...
export class ApplicationService {
  ...
  list(params: FilterParams = {}): Observable<PaginatedResponse<Application>> {
    ...
    return this.http.get<PaginatedResponse<Application>>(this.baseUrl, { params: httpParams });
  }
  ...
  restoreHistory(id: string, historyId: string): Observable<Application> {
    return this.http.post<Application>(`${this.baseUrl}/${id}/history/${historyId}/restore`, {});
  }
  ...
  addStage(id: string, stage: Partial<InterviewStage>): Observable<Application> {
    ...
    return this.http.post<Application>(`${this.baseUrl}/${id}/interview-stages`, payload);
  }

  updateStage(id: string, stageId: string, stage: Partial<InterviewStage>): Observable<Application> {
    const payload = {
      name: stage.name,
      order: stage.order,
      isCompleted: stage.isCompleted ?? false,
    ...
    return this.http.patch<Application>(`${this.baseUrl}/${id}/interview-stages/${stageId}`, payload);
  }

  removeStage(id: string, stageId: string): Observable<Application> {
    return this.http.delete<Application>(`${this.baseUrl}/${id}/interview-stages/${stageId}`);
  }
