...
## Docker (compose)
- API mapped to 3001 (container 3001); UI 3000
...
- UI -> API: set `NEXT_PUBLIC_API_URL` (or Vite env equivalents) to match the running API port (3001 local and via Docker)
