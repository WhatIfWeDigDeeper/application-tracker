...
| interview_stages_application_id_fkey | FOREIGN KEY | FOREIGN KEY (application_id) REFERENCES python_fastapi.applications(id) ON DELETE CASCADE |
...
| Name | Definition |
| ---- | ---------- |
| interview_stages_pkey | CREATE UNIQUE INDEX interview_stages_pkey ON python_fastapi.interview_stages USING btree (id) |
