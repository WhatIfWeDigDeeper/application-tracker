...
export function ApplicationEdit({ applicationId }: ApplicationEditProps) {
  const navigate = useNavigate();
  const isEditMode = !!applicationId;

  // TanStack Query for fetching application data
  const { data: application, isLoading: loading, error: fetchQueryError, refetch } = useApplication(applicationId);
  ...
  }, [isEditMode, application, captureSnapshot]);
