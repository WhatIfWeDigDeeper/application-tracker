...
// Define the react_nestjs schema
export const reactNestjsSchema = pgSchema('react_nestjs');

// Enums
export const applicationStatusEnum = reactNestjsSchema.enum('application_status', [
  'applied',
  'rejected',
  'interviewing',
  'given offer',
...
export const companyCategoryEnum = reactNestjsSchema.enum('company_category', [
  'education',
  'health',
  'climate',
  'ai',
...
export const jobSourceEnum = reactNestjsSchema.enum('job_source', [
  'recruiter',
  'linkedin',
  'indeed',
  'friend',
...
// Tables
export const applications = reactNestjsSchema.table('applications', {
...
export const interviewStages = reactNestjsSchema.table('interview_stages', {
  id: uuid('id').primaryKey().$defaultFn(() => crypto.randomUUID()),
...
export const applicationHistory = reactNestjsSchema.table('application_history', {
  id: uuid('id').primaryKey().$defaultFn(() => crypto.randomUUID()),
  applicationId: uuid('application_id')
    .notNull()
    .references(() => applications.id, { onDelete: 'cascade' }),
